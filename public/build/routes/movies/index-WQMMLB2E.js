import {
  useLoaderData
} from "/build/_shared/chunk-DQNTXM7S.js";
import {
  React,
  init_react
...
function Index() {
  async function getMovies() {
    let res = await fetch(`https://api.themoviedb.org/3/movie/550?api_key=8b62f4bda40c67dbe48ddb6db1f858dc`);
    return res;
  }
  let loader = async () => {
    return getMovies();
...
//# sourceMappingURL=/build/routes/movies/index-WQMMLB2E.js.map
